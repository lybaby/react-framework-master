...
import FRC from '../../../components/form/main';

const { Checkbox, CheckboxGroup, Input, RadioGroup, Row, Select, File, Textarea } = FRC;

const Playground = () => {
    const validateOnSubmitChoice = false;
    const validatePristineChoice = true;
        ...
        >
            <fieldset>
                ...
                <Input
                    ...
                    value=""
                    rowClassName="test2"
                    labelClassName="test3"
                    elementWrapperClassName="test4"
                    label="文本框"
                    className="test"
                    type="text"
                    placeholder="Here is a text input."
                    help="This input is required"
                    required
            ...
            <fieldset>
                <Row >
                    ...
                    {' '}
                    <input className="btn btn-primary" formNoValidate={false} type="submit" defaultValue="Submit" />
                </Row>
            </fieldset>
        </FRC.Form>
    );
