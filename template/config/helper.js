...
function createCommonEntry(cfg) {
  if (Array.isArray(cfg)) {
    ...
    obj.table = [`${paths.appCommon}/table/index.js`,
              `${paths.appCommon}/pagination/index.js`,
              `${paths.appCommon}/swipe/reactSwipe.js`,
              `${paths.appCommon}/form/main.js`];
    return obj;
  }
